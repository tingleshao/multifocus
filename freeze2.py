# freeze2: zoom in/out
# this version should register the in_focus image on the out_of_focus one
# should support mouse rotate zoom in / out 
# this time let the computer connect to two cameras 
